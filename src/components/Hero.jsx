...
export default function Hero() {
  return (
    <main className="text-light md:flex flex-row items-center justify-between rounded-md py-1.5 px-4 md:px-7 w-full md:w-[1300px] mx-auto">
      <div className="flex flex-col gap-6 items-center text-center md:items-start md:text-left">
        ...
        <h2 className="text-6xl text-stone-900 font-semibold max-w-[90%]">
      ...
      <div>
        <img src="https://picsum.photos/900/800" alt="Imagem aleatória" />
      </div>
    </main>
  );
}
